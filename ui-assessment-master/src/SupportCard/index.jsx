...
export default function SupportCard({ data }) {
    ...
    return (
        <div role="region" aria-labelledby="support-contact" className={styles.wrapper}>
            ...
            <div className={styles.contentinfo}>
                ...
                <div className={styles.contactsupport}>
                    <span aria-label="Support Contact Name"><strong>{data.supportContact.name}</strong></span>
                    <span aria-label="Support Contact Email" className={styles.email}><FontAwesomeIcon icon={faEnvelope} color='#606060' style={{ marginRight: '0.5em' }} />
